/* INSONET Systems — Main JavaScript
   Author: INSONET Systems
   Email: info@insonetgh.com
   Website: https://insonetgh.com
   File Description: Navbar, scroll spy, and UI helpers
*/
...
if (!window.__insonetAppInit) {
window.__insonetAppInit = true;
